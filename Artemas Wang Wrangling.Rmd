...
files.to.read <- list.files(path = "/Users/artemaswang/Desktop/Ampersand Test", pattern="xlsx", full.names = TRUE)
...
files.to.read <- list.files(path = "/Users/artemaswang/Desktop/Ampersand", pattern="csv", full.names = TRUE)
