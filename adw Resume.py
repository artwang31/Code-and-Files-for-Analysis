# Text Variables https://towardsdatascience.com/generating-a-resume-in-python-1480a4d6a399
Header = '>>>This resume was generated entirely in Python. For full sourcecode, view my github portfolio.'
Name = 'ARTEMAS DANIEL WANG'
Title = 'Data Science and Analytics'
Contact = 'artemaswang@gmail.com \n 917-935-7179'
ProjectsHeader = 'PROJECTS'
ProjectOneTitle = 'NYC Restaurant Grades and Analysis'
ProjectOneDesc = '- Tidied and wrangled dataset of all restaurants in New York City. \n- Analyzed scores and grades to recommend cleanest rated restaurant in NYC.\n- Cleaned and visualized data using R and ggplot2 package.'
ProjectTwoTitle = 'Democratic Candidates Commercial Exposure Analysis'
ProjectTwoDesc = '- Cleaned and combined several datasets using tidyr and diplyr package. \n- Created visualization that displayed nominee exposure on cable television.'
ProjectThreeTitle = 'Football (Soccer) Statistics'
ProjectThreeDesc = '- Created heatmap visualization depicting which country had most football wins.\n- Created new dataset displaying all international football matches with scores.'
EduHeader = 'EDUCATION'
